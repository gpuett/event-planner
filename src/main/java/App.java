        ...
        while (planning){
            try {
                ...
                if (navigationChoice.equals("packages")) {
                        ...
                        System.out.println("Below are the contents and special pricing for our wedding, birthday, and reunion packages, respectively.");
                        ...
                        while (deciding) {
                        System.out.println("");
                        System.out.println("Which package interests you: wedding, birthday, or reunion?");
                        String packageChoice = bufferedReader.readLine().toLowerCase();
                        if (packageChoice.equals("wedding")) {
                            double weddingPrice = wedding.getPackageCost();
                            System.out.println("You have chosen the wedding package. Your total cost will be: " + formatter.format(weddingPrice));
                            System.out.println("Thank you! Goodbye!");
                            deciding = false;
                            planning = false;
                        } else if (packageChoice.equals("birthday")) {
                            double birthdayPrice = birthday.getPackageCost();
                            System.out.println("You have chosen the birthday package. Your total cost will be: " + formatter.format(birthdayPrice));
                            System.out.println("Thank you! Goodbye!");
                            deciding = false;
                            planning = false;
                        } else if (packageChoice.equals("reunion")) {
                            double reunionPrice = reunion.getPackageCost();
                            System.out.println("You have chosen the reunion package. Your total cost will be: " + formatter.format(reunionPrice));
                            System.out.println("Thank you! Goodbye!");
                            deciding = false;
                            planning = false;
                        } else {
